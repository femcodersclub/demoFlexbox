...
// Detectar si la ventana es redimensionada para mostrar mensaje sobre responsividad
let resizeTimeout;
...
// Función para crear un elemento "Nuevo" ocasionalmente
...
console.log('¡Bienvenido a la demo de Flexbox! Experimenta con los controles para ver cómo funciona Flexbox en la práctica.');
console.log('Presiona la tecla "n" para agregar un nuevo elemento al contenedor flex.');